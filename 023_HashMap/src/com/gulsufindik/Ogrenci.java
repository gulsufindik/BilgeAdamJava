...
public class Ogrenci {
	...
	public Ogrenci(String ad, String soyad, int sayisalPuan, int sozelPuan, int eaPuan) {
		super();
		this.ad = ad;
		this.soyad = soyad;
	...
	public String toString() {
		return "Ogrenci [ad=" + ad + ", soyad=" + soyad + ", sayisalPuan=" + sayisalPuan + ", sozelPuan=" + sozelPuan
				+ ", eaPuan=" + eaPuan + "]";
	}
