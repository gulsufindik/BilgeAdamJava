...
//		System.out.print("Hello Java 3");
		...
		//byteValue = shortValue; -> Direk olarak bu şekilde atama yapamayız casting gerekiyor..
		...
		short sh2 = 2;
		short sh3;
		//sh3 = sh1 + sh2; // yine hata verir casting lazım. Casting işlemi yaparken Java insiyatifi bize bırakır.
						// Değerleri bizim kontrol etmemiz lazım toplam değerin short değeri geçmemesi lazım
		sh3 = (short) (sh1 + sh2); // int'e kadar bu tarz hatalar alırsınız. İnt'ten sonra bu tarz hatalar almazsınız.
		...
		// longValue = 95568584185421421; bu şekilde sağ taraf int'in sınırını geçerse atamada hata alırsınız!
		...
		// çözüm: çarpılan sayıların ilkine long tipinde bir sayı eklenirse sağ taraf long olur:
