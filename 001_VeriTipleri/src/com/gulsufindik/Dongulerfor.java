...
//		
		// Bir şeyi n kere yazdıracaksam kaç kere saydığımı kontol edebilmek için bir değişkene ihtiyacım var.
...
//		
		...
		// int i; // ambiguity -> Döngülerde kullandığınız sayaç değişken isimlerini kod içinde kullanmamaya çalışın.
		System.out.println("\n*******\n");
...
//		}
		...
		int toplam = 0; // toplam değişkenini tanımladım ve 0'ı ilk değer olarak atadım ( initialize ettim)
		int z=0;
		for(int i =1; i<=10;i++) {
			toplam = toplam + i;
		}
		...
		// Eğer kod bloğu içinde index'i (sayacı) değiştirmek gereken durumlar oluyorsa "while" veya "do while" döngülerini kullanınız.
		for(int i=0; i<11; i++) {
			i = 10;
		...
		// Başlangıç ve bitiş sayıları arasında 7'ye bölünebilen sayıları ekrana yazdırın
