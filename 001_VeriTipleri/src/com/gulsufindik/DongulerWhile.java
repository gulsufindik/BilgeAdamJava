...
//				}
//		
		// Döngünün devam edip etmeme durumu döngü içindeki kod metninde belirlenecekse(değişecekse)
...
//				
				// DO WHILE DÖNGÜSÜ:
				// do-while döngüsü içindeki kısım en az 1 kere mutlaka çalışır, daha sonra koşula göre çalışır...
				/*
				 * do {
				 *    //kodlar
				 *    } while (koşul)
