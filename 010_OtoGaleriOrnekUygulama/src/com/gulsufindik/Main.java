...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Galerideki anlık oto sayısı : " + kardeslerOtoGaleri.getGaleridekiOtomobilSayisi() + "\n\n");
		...
		// findCount()
		System.out.println();
		System.out.println(kardeslerOtoGaleri.getGaleriAdi() + " galerisindeki Audi Sayısı : "
				+ kardeslerOtoGaleri.findCout("audi"));
		System.out.println(kardeslerOtoGaleri.getGaleriAdi() + " galerisindeki BMW Sayısı : "
				+ kardeslerOtoGaleri.findCout("bmw"));
		System.out.println(galeriSuperCar.getGaleriAdi() + " galerisindeki Renault Sayısı : "
				+ galeriSuperCar.findCout("Renault"));
